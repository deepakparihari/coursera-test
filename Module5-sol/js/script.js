...
(function (global) {
	...
	$ajaxUtils.sendGetRequest(homeHtml, function (responseText) {
	    $ajaxUtils.sendGetRequest(allCategoriesUrl, function(categories) {
	    	...
	    	var randomCategoryShortName = categories[rand].short_name;
	...
	dc.randomCategoryShortName = function (randomCategoryShortName){
		showLoading("#main-content");
		$ajaxUtils.sendGetRequest(menuItemsUrl + randomCategoryShortName, buildAndShowMenuItemsHTML);
	};
